...
(define coffee2 (instantiate thing 'coffee2))
(ask Intermezzo 'appear coffee2)

(define coffee3 (instantiate thing 'coffee3))
(ask Intermezzo 'appear coffee3)

(define take-all-tester (instantiate person 'take-all-tester Intermezzo))
(define take-all-tester2 (instantiate person 'take-all-tester2 Intermezzo))
